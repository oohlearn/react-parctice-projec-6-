...
function AdminProducts() {
  ...
  useEffect(() => {
    productsModal.current = new Modal("#productModal", { backdrop: "static" });
    getProducts();
  ...
  const openProductsModal = (type, product) => {
    setType(type);
    setTempProduct(product);
    ...
    <div className="p-3">
      ...
      <div className="text-end">
        <button
          ...
          onClick={() => openProductsModal("create", {})}
        >
          建立新商品
        </button>
      </div>
              ...
              <tr key={product.id}>
                ...
                <td>
                  <button
                    type="button"
                    className="btn btn-primary btn-sm"
                    onClick={() => openProductsModal("edit", product)}
                  >
                    編輯
                  </button>
                  <button
